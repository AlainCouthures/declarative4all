Ã¯Â»Â¿<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template name="config">
		<options>
		</options>
		<properties> <!--  accessible at run time -->
			<html>4</html>
			<language>fr</language			<domengine name="Fleur" urle/js/fleur.js" uri="http://www.agencexml.com/Fleur" version="1.0"/>
>
			...
			<calendar.month1>FÃƒÂ©vrier</calendar.month1>
			...
			<calendar.month7>AoÃƒÂ»t</calendar.month7>
			...
			<calendar.month11>DÃƒÂ©cembre</calendar.month11>
			...
			<format-number.NaN>Non numÃƒÂ©rique</format-number.NaN>

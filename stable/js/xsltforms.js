					...
					try {
						...
						if (subm.replace === "all") {
							...
							if( subm.show === "new" ) {
								...
								if(document.write) {
									alert(resp);
									resp2 = `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xalan="http://xml.apache.org/xalan" xmlns:ajx="http://www.ajaxforms.net/2006/ajx" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:txs="http://www.agencexml.com/txs" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dcterms="http://purl.org/dc/terms/"><!--HTML elements and Javascript instructions generated by XSLTForms 1.4 (654) - Copyright (C) 2019 <agenceXML> - Alain COUTHURES - http://www.agencexml.com--><head><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><script type="text/javascript" id="xsltforms-initialdate">CKEDITOR = null;
									var xsltforms_d0 = new Date();
									XsltForms_fullDomEngine = "";
									XsltForms_domEngine = "";
									XsltForms_xpathEngine = "";
									</script><link type="text/css" href="css/xsltforms.css" pivalue="" rel="stylesheet" /><title>Hello World in XForms</title><script type="text/javascript" id="xsltforms-src" src="js/xsltforms.js" data-uri="http://www.agencexml.com/xsltforms" data-version="654">/* */</script><script type="text/javascript" id="xsltforms-generatedscript">/* XsltForms_MagicSeparator */
									...
									XsltForms_globals.xsltHome = "";
									XsltForms_globals.xsltEngine = "libxslt\x20http://xmlsoft.org/XSLT/\x20";
									...
									XsltForms_xpath.create(xsltforms_subform,"concat('Hello\x20',\x20PersonGivenName,\x20'.\x20We\x20hope\x20you\x20like\x20XForms!')",false,new XsltForms_functionCallExpr('http://www.w3.org/2005/xpath-functions concat',new XsltForms_cteExpr('Hello\x20'),new XsltForms_locationExpr(false,new XsltForms_stepExpr('child',new XsltForms_nodeTestName('','PersonGivenName'))),new XsltForms_cteExpr('.\x20We\x20hope\x20you\x20like\x20XForms!')));
									XsltForms_xpath.create(xsltforms_subform,"PersonGivenName",false,new XsltForms_locationExpr(false,new XsltForms_stepExpr('child',new XsltForms_nodeTestName('','PersonGivenName'))));
									var xsltforms_model_4_2_1_ = XsltForms_model.create(xsltforms_subform,"xsltforms-mainform-model-default",null,null,null);
									
									XsltForms_instance.create(xsltforms_subform,"xsltforms-mainform-instance-default",xsltforms_model_4_2_1_,false,"application/xml",null,'&lt;data\x20xmlns=""&gt;&lt;PersonGivenName/&gt;&lt;/data&gt;');
									new XsltForms_input(xsltforms_subform,xsltforms_subform.id + "-input-4_4_1_",2,"text",new XsltForms_binding(null, "PersonGivenName"),null,"true",null,null,null);
									new XsltForms_output(xsltforms_subform,xsltforms_subform.id + "-output-8_4_1_",1,new XsltForms_binding("xsd:string", "concat('Hello\x20',\x20PersonGivenName,\x20'.\x20We\x20hope\x20you\x20like\x20XForms!')"),null);
									XsltForms_browser.dialog.show('statusPanel');
									if (xsltforms_subform.id === "xsltforms-mainform") {
									...
									</script></head><body><!--XsltForms_MagicSeparator--><p>Type your first name in the input box. <br xmlns="" />
													If you are running XForms, the output should be displayed in the output area.</p><span id="xsltforms-mainform-input-4_4_1_" class="xforms-disabled xforms-control xforms-input xforms-appearance"><span class="focus"> </span><label for="xsltforms-mainform-input-input-4_4_1_" id="xsltforms-mainform-label-2_4_4_1_" class="xforms-label">Please enter your first name: </label><span class="value"><input type="text" id="xsltforms-mainform-input-input-4_4_1_" incremental="true" class="xforms-value" /></span><span class="xforms-required-icon">*</span><span class="xforms-alert"><span class="xforms-alert-icon"> </span></span></span><br xmlns="" /><span id="xsltforms-mainform-output-8_4_1_" class="xforms-disabled xforms-control xforms-output xforms-appearance"><label id="xsltforms-mainform-label-2_8_4_1_" class="xforms-label">Output: </label><span class="value"><span value="concat('Hello ', PersonGivenName, '. We hope you like XForms!')" class="xforms-value"> </span></span></span><!--XsltForms_MagicSeparator--><div id="xsltforms_console"> </div><div id="statusPanel">... Loading ... </div></body></html>`;
									document.write(resp);
									document.close();
								} else {
									if (resp.indexOf("<?", 0) === 0) {
